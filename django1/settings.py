...
SECRET_KEY = 'django-insecure-6y19i8*e-&*q(2ce+r&lcxl_qgm-jq*-^=jsf=^e8^0524ihph'
...
STATIC_URL = 'static/'  # usando durente o desenvolvimento
...
LOGOUT_REDIRECT_URL = 'core/templates/index'
